...
namespace IDBDatabase
  ...
  export
  createObjectStore' :  (obj : IDBDatabase)
                     -> (name : String)
                     -> JSIO IDBObjectStore
  ...
  transaction a b c d = primJS
                      $ IDBDatabase.prim__transaction a
                                                      (toFFI b)
                                                      (toFFI c)
                                                      (optUp d)

  export
  transaction' :  (obj : IDBDatabase)
               -> (storeNames : NS I [ String , Array String ])
               -> JSIO IDBTransaction
...
namespace IDBFactory
  ...
  open_ :  (obj : IDBFactory)
        ...
        -> JSIO IDBOpenDBRequest
  open_ a b c = primJS $ IDBFactory.prim__open a b (toFFI c)

  export
  open' : (obj : IDBFactory) -> (name : String) -> JSIO IDBOpenDBRequest
  open' a b = primJS $ IDBFactory.prim__open a b undef
...
namespace IDBKeyRange
  ...
  bound a b c d = primJS
                $ IDBKeyRange.prim__bound (toFFI a)
                                          (toFFI b)
                                          (toFFI c)
                                          (toFFI d)
...
namespace IDBObjectStore
  ...
  export
  createIndex' :  (obj : IDBObjectStore)
               -> (name : String)
               -> (keyPath : NS I [ String , Array String ])
               -> JSIO IDBIndex
...
namespace IDBOpenDBRequest
  ...
  onupgradeneeded v = fromNullablePrim "IDBOpenDBRequest.getonupgradeneeded"
...
namespace IDBRequest
  ...
  onerror :  (0 _ : JSType t)
          ...
          -> t
          -> Attribute False Maybe EventHandlerNonNull
  onerror v = fromNullablePrim "IDBRequest.getonerror"
                               prim__onerror
                               prim__setOnerror
                               (v :> IDBRequest)
  ...
  onsuccess :  (0 _ : JSType t)
            ...
            -> t
            -> Attribute False Maybe EventHandlerNonNull
  onsuccess v = fromNullablePrim "IDBRequest.getonsuccess"
                                 prim__onsuccess
                                 prim__setOnsuccess
                                 (v :> IDBRequest)
...
namespace IDBDatabaseInfo
  ...
  name v = fromUndefOrPrimNoDefault "IDBDatabaseInfo.getname"
                                    prim__name
                                    prim__setName
                                    (v :> IDBDatabaseInfo)
  ...
  version v = fromUndefOrPrimNoDefault "IDBDatabaseInfo.getversion"
                                       prim__version
                                       prim__setVersion
                                       (v :> IDBDatabaseInfo)
...
namespace IDBIndexParameters
  ...
  multiEntry v = fromUndefOrPrim "IDBIndexParameters.getmultiEntry"
                                 prim__multiEntry
                                 prim__setMultiEntry
                                 False
  ...
  unique :  (0 _ : JSType t)
         ...
         -> t
         -> Attribute True Optional Bool
  unique v = fromUndefOrPrim "IDBIndexParameters.getunique"
                             prim__unique
                             prim__setUnique
                             False
                             (v :> IDBIndexParameters)
...
namespace IDBObjectStoreParameters
  ...
  autoIncrement :  (0 _ : JSType t)
                ...
                -> t
                -> Attribute True Optional Bool
  autoIncrement v = fromUndefOrPrim "IDBObjectStoreParameters.getautoIncrement"
                                    prim__autoIncrement
  ...
  keyPath v = fromUndefOrPrim "IDBObjectStoreParameters.getkeyPath"
                              prim__keyPath
                              prim__setKeyPath
                              Nothing
                              (v :> IDBObjectStoreParameters)
...
namespace IDBTransactionOptions
  ...
  durability v = fromUndefOrPrimNoDefault "IDBTransactionOptions.getdurability"
                                          prim__durability
                                          prim__setDurability
...
namespace IDBVersionChangeEventInit
  ...
  newVersion v = fromUndefOrPrim "IDBVersionChangeEventInit.getnewVersion"
                                 prim__newVersion
                                 prim__setNewVersion
                                 Nothing
  ...
  oldVersion v = fromUndefOrPrim "IDBVersionChangeEventInit.getoldVersion"
                                 prim__oldVersion
                                 prim__setOldVersion
                                 0
                                 (v :> IDBVersionChangeEventInit)
